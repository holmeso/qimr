...
import org.qcmg.common.log.*;	
	...
	public class VcfCompareOptions {
	...
	final String version = au.edu.qimr.utility.Main.class.getPackage().getImplementationVersion();	
	
	public VcfCompareOptions( final String[] args) throws Exception {	
