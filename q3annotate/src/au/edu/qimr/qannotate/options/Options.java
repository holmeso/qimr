...
public class Options {
	public enum MODE {fix, dbSNP, germline, snpEff,confidence,customerConfidence,vcf2maf, cadd,repeatmask}
   ...
   protected static final String control = "control";
    ...
    public boolean parseArgs(final String[] args) throws Exception{ 
        ...
        if(options.has("mode")){  
			...
			else if(m.equalsIgnoreCase(MODE.repeatmask.name()))
				modeOptions = new RepeatMaskOptions();			
			else{ 
